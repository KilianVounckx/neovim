...
syn keyword valeControl as else func for foreach in if imm impl infer-ret inl lock mat mut nad not or ret yon while
syn keyword valeKeywords abstract destruct drop interface rules sealed struct this virtual weakable exported export extern set
